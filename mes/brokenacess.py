...
def create_users(session):
    ...
    res=session.post("https://smartfactory.bevywise.com/employee",data={"csrfmiddlewaretoken":session.cookies.get('csrftoken'),"department":"vmpprocess","employee_id":"vprocess-supervisor2@gmail.com", "role":"supervisor","password":password,"role_id":2},headers={'Referer':'https://smartfactory.bevywise.com/'})
    if res.ok:
        print(res.json())
        ...
        op_res=supsess.post("https://smartfactory.bevywise.com/ppc/machine_list_op/",data={"csrfmiddlewaretoken":supsess.cookies.get('csrftoken'),"assign_operator":"process operator2","assign_machine":"vmpmachine","line_no":"vmpprocess","op_list":'["process_operator2"]'},headers={'Referer':'https://smartfactory.bevywise.com/'})
        if op_res.ok:
    ...
    res=session.post("https://smartfactory.bevywise.com/employee",data={"csrfmiddlewaretoken":session.cookies.get('csrftoken'),"department":"vmpprocess","employee_id":"vprocess-head2@gmail.com", "role":"Department Head","password":password,"role_id":3},headers={'Referer':'https://smartfactory.bevywise.com/'})
    if res.ok:
        print("process head created")
    else:
        print("error in creating process-head")
    res=session.post("https://smartfactory.bevywise.com/employee",data={"csrfmiddlewaretoken":session.cookies.get('csrftoken'),"department":"store","employee_id":"vstore-executive2@gmail.com", "role":"Executive","password":password,"role_id":6},headers={'Referer':'https://smartfactory.bevywise.com/'})
    if res.ok:
        print("store-executive created")
    else:
        print("error in creating store-executive")
    res=session.post("https://smartfactory.bevywise.com/employee",data={"csrfmiddlewaretoken":session.cookies.get('csrftoken'),"department":"store","employee_id":"vstore-manager2@gmail.com", "role":"Manager","password":password,"role_id":7},headers={'Referer':'https://smartfactory.bevywise.com/'})
    if res.ok:
        print("store-manager created")
    else:
        print("error in creating store-manager")
    res=session.post("https://smartfactory.bevywise.com/employee",data={"csrfmiddlewaretoken":session.cookies.get('csrftoken'),"department":"store","employee_id":"vstore-viewer2@gmail.com", "role":"Viewer","password":password,"role_id":8},headers={'Referer':'https://smartfactory.bevywise.com/'})
    if res.ok:
        print("store-viewer created")
    else:
        print("error in creating store-viewer")
    res=session.post("https://smartfactory.bevywise.com/employee",data={"csrfmiddlewaretoken":session.cookies.get('csrftoken'),"department":"maintenance","employee_id":"vmain-executive2@gmail.com", "role":"Executive","password":password,"role_id":4},headers={'Referer':'https://smartfactory.bevywise.com/'})
    if res.ok:
        print("main-executive created")
    else:
        print("error in creating main-executive")
    res=session.post("https://smartfactory.bevywise.com/employee",data={"csrfmiddlewaretoken":session.cookies.get('csrftoken'),"department":"maintenance","employee_id":"vmain-manager2@gmail.com", "role":"Manager","password":password,"role_id":5},headers={'Referer':'https://smartfactory.bevywise.com/'})
    if res.ok:
